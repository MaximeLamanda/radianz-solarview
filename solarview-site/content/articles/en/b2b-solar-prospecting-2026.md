...
## A shared A / B / C qualification grid

Once the data foundation is in place, the team needs shared rules. Without a common grid, every rep prioritizes differently and reporting becomes incomparable.

Start with simple criteria everyone understands: minimum usable surface (often 800–1,500 m² depending on your offer), acceptable coverage ratio, target sector, maximum distance from your service base. These filters eliminate 60–70% of weak opportunities before any human contact.
...
To make this actionable, we recommend three tiers. An **A** account combines high usable surface, compatible daytime consumption, an identified decision-maker, and an urgency signal (regulatory or planned works). A **B** account shows real potential but uncertainty on consumption, owner-tenant status, or timeline. A **C** account should be parked: insufficient surface, likely structural constraints, or site outside geographic scope. Each tier should trigger a different action: direct contact within 48 hours for A accounts, nurture sequence for B, documented archive for C.
...
Radianz was built for this exact case: map high-potential roofs, score C&I opportunities, and generate shareable quantified proposals before the first meeting. If you are looking for solar prospecting software built for commercial and industrial — not residential — you can [request a demo](/contact) to see how to structure this loop on your territory.

## Useful sources

Three references help deepen market and regulatory context. [ADEME](https://www.ademe.fr/particuliers-professionnels/professionnels) provides guidance on solar in professional settings and support programs. Photovoltaique.info details [parking lot solarization obligations](https://www.photovoltaique.info/fr/preparer-un-projet/quel-type-de-projet/obligations-de-solarisation/obligation-de-solarisation-des-parcs-de-stationnement-exterieurs/) under APER. Finally, our article on [APER 2026](/en/articles/aper-solarisation-commercial-buildings-parking-2026) shows how to turn these obligations into commercial scoring criteria.
