...
Le terrain reste indispensable. Rien ne remplace la visite sur site pour valider l'état de la couverture, les contraintes d'accès, ou la disponibilité du décideur. Mais le terrain doit venir après un premier filtrage data, pas avant. L'[ADEME rappelle d'ailleurs](https://www.ademe.fr/particuliers-professionnels/professionnels) que le potentiel solaire d'un bâtiment dépend autant de sa consommation que de sa surface disponible — deux variables que l'on peut estimer avant la visite.
...
Pour approfondir le contexte marché et réglementaire, trois références sont utiles. L'[ADEME](https://www.ademe.fr/particuliers-professionnels/professionnels) propose des fiches sur le solaire en milieu professionnel et les démarches d'accompagnement. Photovoltaique.info détaille les [obligations de solarisation des parkings](https://www.photovoltaique.info/fr/preparer-un-projet/quel-type-de-projet/obligations-de-solarisation/obligation-de-solarisation-des-parcs-de-stationnement-exterieurs/) dans le cadre APER. Enfin, notre article sur la [loi APER 2026](/fr/articles/loi-aper-solarisation-batiments-parkings-2026) montre comment transformer ces obligations en critères de scoring commercial.
